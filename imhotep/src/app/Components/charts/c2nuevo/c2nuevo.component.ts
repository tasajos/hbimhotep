...
@Component({
  selector: 'app-c2nuevo',
  templateUrl: './c2nuevo.component.html',
  styleUrls: ['./c2nuevo.component.css']
})
export class C2nuevoComponent implements OnInit {
  ...
  getTiposReq(): void {
    this.charsdesk.gettiposreqnuevo().subscribe(
